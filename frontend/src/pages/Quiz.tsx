  ...
  return (
    <div className="quiz-container">
      ...
      <p style={{ textAlign: 'center', marginTop: '-30px' }}>
        Your answers will help us understand your passions and connect you with
        nonprofits that fit your goals, values, and vision for making an impact.
        Take the quiz and discover organizations worth supporting.
      </p>
